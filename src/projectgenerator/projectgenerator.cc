...
*/
void ProjectGenerator::setupUnitTestingFramework()
{
    ...
    file.close();
    Log::log("unit testing template code added to project run tests with : ProjectGenerator utest", Type::E_DISPLAY);
};
...
//
void ProjectGenerator::generateLicenceFile()
{
	std::ofstream out;
